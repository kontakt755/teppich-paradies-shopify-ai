...
| 2026-09-20 | Ein Vergleichspreis im Admin allein zeigt im Shop nichts. Streichpreis und Sale-Badge brauchen zusaetzlich ein gesetztes `aktion.start` (und kein abgelaufenes `aktion.ende`). Damit endet eine Aktion mit dem Enddatum auch in der Anzeige von selbst. | Fable, auf Basis der Streichpreis-Regel von Ahmet |
| 2026-09-20 | Kollektions-Einstieg: nie pauschal "Preis aufsteigend". Erste Viererreihe = Mitte, Einstiegsanker, Mitte, gehoben; Premium ab 150 EUR/m2 fruehestens ab Platz 9. Unterkollektionen sind manuell sortiert, solange es keine belastbaren Verkaufszahlen gibt. | Vorgabe Ahmet, Regel Fable |
| 2026-09-20 | Teppich-PDP: der Preis steht einmal ("Ihr Preis"), der Knopf heisst nur "In den Warenkorb". Keine Gedankenstriche in Knoepfen. | Ahmet |
| 2026-09-20 | Farbwahl und Bild gehoeren zusammen: auf dem Handy zeigt ein grosses Bild direkt unter der Farbwahl die gewaehlte Farbe (statt die Seite umzubauen - Titel/Preis ueber die Galerie zu ziehen haette das Theme-Raster aufgebrochen). Bei Einwand: Umbau als eigenes Paket. | Ahmet (Problem), Fable (Loesung) |
| 2026-09-20 | Rabatte werden unabhaengig vom EK eingepflegt (5-25 %), solange die EK-Liste fehlt. Nie pauschal: hoechstens rund ein Fuenftel einer Kollektion, Premium ohne Rabatt, feste Laufzeit (4 Wochen), Streichpreis nur der belegte Vorpreis. | Ahmet |
