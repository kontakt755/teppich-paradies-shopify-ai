...
| 6 | Datenschutzerklaerung um Newsletter (Double-Opt-in, Versanddienst, Abmeldung), Tag Manager/Google-Tag und das Bewertungs-Widget ergaenzen | Rechtstext ist Inhabersache; vorher schalte ich keine Newsletter-Anmeldung sichtbar. Faktenliste fuer den Rechtstext-Anbieter liegt bereit: `docs/kundenbindung/datenschutz-faktenliste.md` | #422, `docs/kundenbindung/README.md` Abschnitt 4 |
