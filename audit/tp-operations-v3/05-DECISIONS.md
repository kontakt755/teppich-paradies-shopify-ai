...
| D6 | `workflow/graphql-proxy.mjs` als einziger Admin-Client; `bulk-update-vendor.mjs` stilllegen; `sync-orchestrator.mjs` loeschen oder als Doku markieren | Drei Auth-Pfade sind der belegte Grund fuer #34 | – | **umgesetzt 2026-09-23** (beide Dateien entfernt) |
