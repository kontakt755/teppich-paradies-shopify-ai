...
Anzahl bestätigter Issues: P0: 0 · P1: 0 · P2: 5 · P3: 6 · P4: 0. Davon TP-004–007 ausschließlich lokal bestätigte bedingte Codefehler; TP-006/007 historisch ruhender Pfad, aktuelle Live-Betroffenheit nicht belegt. TP-008 lokal bestätigter Cart-Anzeigeverlust, keine falsche Menge/Geldabrechnung. TP-009 lokal bedingter Rollenbreiten-/Mengenfehler, heutige PVC-Konfiguration offen. TP-010 lokal bestätigte fehlende Wiederherstellung nach abgelehnter Cartlöschung, Browser-/Live-Reichweite H-012. TP-011 lokal verlorene Mengenereignisse, reale Browserreichweite ebenfalls H-012.

Aktuell untersuchter Bereich: Warenkorb, Phase 1.
Letzte abgeschlossene Aufgabe: CART-002b.1. Zwölf lokale Fälle/elf Requests, fünf historische Hashvergleiche. TP-011 in fünf Fällen: gemeinsamer 300-ms-Timer verwirft andere Cartzeilen oder eigene Änderung nach fremdem Ereignis. Wiederholung derselben Zeile wird korrekt zusammengefasst. Keine Shopänderung oder S01–S08-Replays.
Nächste Aufgabe: **CART-002b.2**: Antwortreihenfolge und Zeilenidentität bei Cartmutationen, direkter `morphSection` gegenüber `sectionRenderer.renderSection`, Drawer-Ereignisse und Lifecycle. Einstieg `assets/component-cart-items.js`, `assets/section-renderer.js`, `assets/cart-drawer.js`, `assets/events.js` und gegebenenfalls `assets/dialog.js`. SectionRenderer/Drawer in S09 gelesen, noch nicht ausgeführt. Echte Browser-Wiederöffnung/Reload/Checkout getrennt nachholen (H-012). Keine erneuten Preis-, Gruppen- oder Debounce-Diagnosen ohne Quelländerung. Keine Fixphase beginnen.
