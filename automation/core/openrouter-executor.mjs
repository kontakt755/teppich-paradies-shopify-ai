...
export const DEFAULT_OPENROUTER_USAGE_LEDGER = '.router/ai-usage.jsonl';
...
export function appendUsageRecord(record, { ledgerPath = process.env.AI_ROUTER_USAGE_LEDGER ?? process.env.OPENROUTER_USAGE_LEDGER ?? DEFAULT_OPENROUTER_USAGE_LEDGER, io = fs } = {}) {
